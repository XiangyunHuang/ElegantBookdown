...
equote: "Victory won't come to us unless we go to it. --- M. Moore"
version: "3.07"
...
```{r elegantbook-logo,echo=FALSE,out.width="45%",fig.align='center',fig.cap="Elegant Book 标志"}
knitr::include_graphics(path = 'figure/logo.png')
```
