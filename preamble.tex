...
% 字体设置
\setCJKmainfont[BoldFont={Noto Sans CJK SC},ItalicFont={Noto Serif CJK SC SemiBold}]{Noto Serif CJK SC} 
\setCJKsansfont[BoldFont={Noto Sans CJK SC},ItalicFont={Noto Serif CJK SC SemiBold}]{Noto Serif CJK SC SemiBold} 
\setCJKmonofont[BoldFont={Noto Sans CJK SC},ItalicFont={Noto Serif CJK SC SemiBold}]{Noto Serif CJK SC} 
